...
dictionary="$repo_root/build-artifacts/aarch64-linux/BeeDeployment/dict/BeeDeploymentTopologyDictionary.json"
...
ExecStart=$venv_python $watch_script --watch-dir $repo_root/DpCat/fprime-downlink --dictionary $dictionary
Restart=always
RestartSec=5
