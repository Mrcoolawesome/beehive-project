...
#include <BeeDeployment/Top/BeeDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    BeeDeployment::TopologyState inputs;
    ...
    BeeDeployment::setupTopology(inputs);
    BeeDeployment::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    BeeDeployment::teardownTopology(inputs);
