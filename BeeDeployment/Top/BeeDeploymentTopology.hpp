// ======================================================================
// \title  BeeDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef BEEDEPLOYMENT_BEEDEPLOYMENTTOPOLOGY_HPP
#define BEEDEPLOYMENT_BEEDEPLOYMENTTOPOLOGY_HPP
// Included for access to BeeDeployment::TopologyState and BeeDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <BeeDeployment/Top/BeeDeploymentTopologyDefs.hpp>
 ...
 * BeeDeployment::TopologyState see: BeeDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type BeeDeployment::TopologyState see: BeeDeploymentTopologyDefs.hpp.
 *
